...
public class KTALoanPurposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        next = view.findViewById(R.id.btn_next_kta_purpose);
    ...
    private final View.OnClickListener nextForm = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            NavDirections action = KTALoanPurposeFragmentDirections.actionKTALoanPurposeFragmentToKTALoanDocumentFragment();
